...
const LoginPage = () => {
  return (
    <div className="bg-[url('/images/bg-of-site.png')] bg-cover bg-center h-screen flex items-center justify-start px-15">
      <div className="flex flex-col items-center gap-6 max-w-[350px] w-full">
        <div className="w-[150px] h-[150px] rounded-2xl bg-black/10 backdrop-blur-md border border-white/20 shadow flex items-center justify-center text-white">
        ...
        <form className="flex flex-col bg-black/10 backdrop-blur-md border border-white/20 shadow p-6 px-4 items-center justify-start rounded-2xl w-full text-white">
          <p className="mb-4 text-2xl font-bold">Имя ресторана</p>
