...
import type { PostRestaurant, WorkingHour } from "@/entities/res-request/models/types"
...
export function AddRestaurantForm() {
  ...
  const transformToPostRestaurant = (data: RestaurantFormData): PostRestaurant => {
    ...
    const workingHours: WorkingHour[] = Object.entries(data.openingHours).map(([key, value]) => ({
      dayOfWeek: days[key],
            ...
            {currentStep > 1 ? (
              <Button
                ...
                className={cn(
                  ...
                  theme === "dark"
                    ? "text-gray-300 hover:text-white hover:bg-[#2A2730] border border-[#3D3A46]"
