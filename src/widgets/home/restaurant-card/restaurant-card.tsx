...
export function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  return (
    <Link href={`/restaurant/${restaurant.id}`}>
      <Card className="group pt-0 gap-2.5  relative overflow-hidden bg-black/40 backdrop-blur-md border border-white/10 hover:border-orange-500/50 transition-all duration-500 cursor-pointer hover:shadow-2xl hover:shadow-orange-500/20 hover:-translate-y-2">
        {/* Градиентный оверлей */}
